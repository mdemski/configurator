...
const appRoutes: Routes = [
  ...
  {path: 'konfigurator/okna-dachowe/:configId/:productId', component: RoofWindowsConfigComponent},
  {path: 'konfigurator/okna-dachowe/:configId/:productId/:productCode', component: RoofWindowsConfigComponent},
  {path: 'konfigurator/kolnierze', component: FlashingsConfigComponent},
  {path: 'konfigurator/kolnierze/:configId', component: FlashingsConfigComponent},
  {path: 'konfigurator/kolnierze/:configId/:productId', component: FlashingsConfigComponent},
  {path: 'konfigurator/kolnierze/:configId/:productId/:productCode', component: FlashingsConfigComponent},
  {path: 'konfigurator/akcesoria', component: AccessoriesConfigComponent},
  {path: 'konfigurator/akcesoria/:configId', component: AccessoriesConfigComponent},
  {path: 'konfigurator/akcesoria/:configId/:productId', component: AccessoriesConfigComponent},
  {path: 'konfigurator/akcesoria/:configId/:productId/:productCode', component: AccessoriesConfigComponent},
